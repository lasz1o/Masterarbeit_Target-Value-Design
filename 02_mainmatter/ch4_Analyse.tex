...
\begin{itemize}[leftmargin=2em]
    \item \textbf{Phase 0}: Phase 0: Projektinitiierung und Definition (Project Definition)
    \item \textbf{Phase 1}: Validierung und Zielsetzung (Validation \& Target Setting)
    \item \textbf{Phase 2}: Wertorientierte Planung (Value Delivery / Design)
    \item \textbf{Phase 3}: Realisierung und Abschluss (Implementation \& Learning)
\end{itemize}
