...
Effizientes TVD setzt laut Ouma et al. (2025) datenbasierte Entscheidungsprozesse voraus (\enquote{Quantitatively Managed}), was in der Praxis den Einsatz von BIM und modellbasierten Kalkulationsmethoden bedingt.\autocite[vgl.]{ouma_target_2025}
...
Berufshaftpflichtversicherungen decken in der Regel nur Schäden ab, die durch das eigene Verschulden des Versicherungsnehmers entstanden sind. Eine \enquote{No-Blame}-Kultur, bei der das Team kollektiv für Fehler einsteht, ist ohne spezielle Projektversicherungspolicen (die in Deutschland noch unüblich sind) kaum abbildbar. Dies führt dazu, dass Akteure aus Haftungsangst dazu tendieren, Entscheidungen zu dokumentieren und abzugrenzen, anstatt sie kollaborativ zu treffen \autocite[vgl.]{breyer_partnerschaftliche_2023}.

\minisec{Fehlendes \enquote{Organisational Learning} in temporären Projektorganisationen}
Nach dem Reifegradmodell von Ouma et al. (2025) stellt das \enquote{Learning} (systematische Rückführung von Daten in Kennwert-Datenbanken) die höchste Stufe der TVD-Maturity dar \autocite{ouma_target_2025}.
