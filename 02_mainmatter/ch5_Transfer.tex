...
\cref{ch:4} hat aufgezeigt, dass zwischen dem idealtypischen Prozessmodell des Target Value Design (TVD) und verschiedenen Gegebenheiten der deutschen Baupraxis eine Reibungspunkte entstehen können. Die identifizierten Hürden sind Symptome eines Systemkonflikts.
...
Ziel dieses Kapitels ist eine differenzierte Betrachtung: Welche Barrieren lassen sich durch neue Vertragsmodelle (IPA) bereits senken und an welchen Stellen steht der gesetzliche Ordnungsrahmen und die kulturelle Baupraxis in Deutschland einer echten TVD-Umsetzung weiterhin im Weg?
...
\begin{figure}[ht]
    ...
    \caption{Divergenz der Vergabezeitpunkte: VOB-Modell vs. TVD-Modell (Quelle: Eigene Darstellung)}
...
Diese Strategie der juristischen Risikovermeidung führt jedoch zu einer methodischen Entkernung des Target Value Design. Wie die theoretische Herleitung in \cref{ch:4} gezeigt hat, basiert TVD essenziell auf der Einflussnahme auf die Kostentreiber \textit{während} der Entwurfsfindung (LPH 2--3).\autocite[Vgl.][S.~3--4]{ballard_target_2012} Granja et al. (2023) betonen, dass erfolgreiches TVD ein Verschmelzen der Grenzen zwischen Planung und Bau erfordert. \autocite[Vgl.][S.~3]{granja_modelo_2023}.
...
Für öffentliche Auftraggeber entsteht hier ein Zielkonflikt mit dem Gebot der Mittelstandsförderung (§ 97 Abs. 4 GWB).\autocite[Vgl.][§~97 Abs.~4]{noauthor_gesetz_2013}
 Eine konsequente TVD-Ausschreibung, die hohe digitale Kompetenzen (BIM Level 2/3) als Eignungskriterium fordert, wirkt faktisch als Marktzutrittsbarriere für lokale Betriebe.
...
Für viele KMU stellt dieser Paradigmenwechsel ein existenzielles Risiko dar. In einem Markt, der traditionell durch Preiskampf geprägt ist, basiert die Marge des Handwerkers oft auf einer internen Mischkalkulation und geschickten Einkaufskonditionen, die als Geschäftsgeheimnis gehütet werden. Die Forderung, diese Kosten offenzulegen, erzeugt die Angst, gläsern zu werden und in zukünftigen Ausschreibungen angreifbar zu sein. Studien des Zentralverbands Deutsches Baugewerbe (ZDB) deuten darauf hin, dass diese Abwehrhaltung gegen die Offenlegung der wahren Kostenstruktur eines der Haupthindernisse für die Verbreitung partnerschaftlicher Modelle im Handwerk ist \autocite[Vgl.][ S.~37]{zdb_geschaftsbericht_2024}.
...
Für die deutsche Verwaltung würde dies bedeuten, die Wirtschaftlichkeitsuntersuchung nicht als statisches Dokument, sondern als dynamische Steuerungsgröße in den TVD-Prozess zu integrieren.
...
Es wird die These vertreten, dass die verbleibende Fragilität von TVD in Deutschland weniger in der Vertragsgestaltung begründet liegt, sondern in der mangelnden Synchronisation zwischen der iterativen Projektmethodik und der Logik des öffentlichen Genehmigungs- und Haushaltsrechts.
...
Während klassische Defizite wie die Honorar- und Haftungsproblematik durch neue Vertragsmodelle (IPA) wirksam neutralisiert werden können, bleibt ein zentrales Spannungsfeld bestehen: die mangelnde Vereinbarkeit von iterativer Wertentwicklung und sequenzieller Genehmigungslogik.
