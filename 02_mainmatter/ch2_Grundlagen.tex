...
% - Positionierung: IPA als "Betriebssystem" für die Lean-Prinzipien.
% - Zentrale Merkmale definieren:
%   - Frühzeitige Integration aller Schlüsselpartner.
%   - Mehrparteienvertrag.
%   - Gemeinsames Risikomanagement (Chancen-/Risikopool).
%   - Kollaborative Kultur statt adversialer Haltung.

\subsection{Internationale Erfolge und Status Quo in Deutschland}
\label{sec:2.2.3}

% - Internationale Perspektive: Ursprünge und Erfolge im angelsächsischen 
%   Raum (Project Alliancing, IPD) (Quelle: Cook et al., 2014).
% - Situation in Deutschland:
%   - Thema hat stark an Fahrt aufgenommen.
%   - Anzahl der Pilotprojekte nennen (Quelle: Haghsheno et al., 2024).
% - Überleitung zu 2.3: Feststellung, dass TVD die zentrale Methode zur 
%   Kosten- und Wertsteuerung in IPA-Modellen ist.
