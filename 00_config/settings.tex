...
% Hängender Einzug für bessere Lesbarkeit
%\setlength{\bibhang}{1em}           % Einrückung ab 2. Zeile
\setlength{\bibitemsep}{0.5\baselineskip}  % Mehr Abstand zwischen Einträgen

% % Autor fett hervorheben
% \renewcommand*{\mkbibnamefamily}[1]{\textbf{#1}}
% \renewcommand*{\mkbibnamegiven}[1]{\textbf{#1}}

% % Jahr gleich nach Autor, fett
