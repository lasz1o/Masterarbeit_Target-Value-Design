...
\DeclareSourcemap{
  \maps[datatype=bibtex]{
    \map{
      \step[fieldsource=url,match=\regexp{https?://},replace={}]
    }
  }
}
...
\usetikzlibrary{backgrounds, positioning, calc, fit}
...
% Fußnoten manuell einfügen
\usepackage{tablefootnote}  % Für Fußnoten in floats
