% Einmal als Variable definieren
\newcommand{\arbeitstitel}{Target Value Design im Bauwesen -- Strukturierte Analyse und prozessorientierte Darstellung im Kontext der deutschen Baupraxis}
\newcommand{\authorname}{Lasse Krisztian}

% Standard LaTeX-Befehle daraus ableiten
\title{\arbeitstitel}
\author{\authorname}
\date{\today}
